                            ...
                            <div class="body">
                                ...
                                <form method="post">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Nama Pengguna" aria-label="name" aria-describedby="basic-addon1" value="<?php echo $name; ?>">
                                    </div>
                                    <label for="basic-url">Username</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="username" placeholder="Username" aria-label="username" aria-describedby="basic-addon1" value="<?php echo $username; ?>">
                                    </div>
